...
from datacon.views import process_incoming, latest_test, latest_dataset, range_dataset, retriever_view, web_view
...
urlpatterns = [path(r'incoming/<uuid:source_id>', process_incoming, name='process_incoming'),
               ...
               path(r'display/web/<uuid:dataset_id>', web_view, name='web_view'),
